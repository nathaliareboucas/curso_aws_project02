package br.com.reboucas.nathalia.aws_project02.repository;

import br.com.reboucas.nathalia.aws_project02.model.ProductEventKey;
...
public interface ProductEventLogRepository extends CrudRepository<ProductEventLog, ProductEventKey> {
    ...
    List<ProductEventLog> findAllByPkAndSkStratWith(String code, String eventType);
}
